...
def main():
    ...
    document = '<!doctype html>\n<html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="description" content="PostStudio 0.4.5 本地测试版 完整用户手册：按流程学习导入、取样、配色、工作流、导出与项目分享。"><title>PostStudio · 用户手册</title><style>' + STYLE + '</style></head><body>'
    document += '<aside aria-label="手册导航"><div class="brand">PostStudio</div><div class="sub">用户手册 · 0.4.5 本地测试版 · 离线阅读版</div><nav>' + nav + '</nav><button class="print" onclick="window.print()">打印 / 保存为 PDF</button></aside><main>'
